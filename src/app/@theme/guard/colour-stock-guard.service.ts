...
export class ColourStockGuardService {
  ...
  canLoad(route: Route) {
    if (this.currentUser !== undefined && this.userPermission.can_view) {
      ...
      const res = this.permissionService.callPermissionView('Ask for Permission', 'You do not have access permission to View Colour Stock. If you want to View Colour Stock ask admin for permission.');
      if (res) {
