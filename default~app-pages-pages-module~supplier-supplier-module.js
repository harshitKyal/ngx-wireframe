...
var AddEditSupplierRateComponent = /** @class */ (function () {
    function AddEditSupplierRateComponent(toasterService, route, router, supplierService) {
            ...
            this.supplierService.getSupplierRateById(this.id).subscribe(function (data) {
                if (!data[0].error) {
                    ...
                    _this.supplierRateList.forEach(function (ele, index) {
                        ele.index = index + 1;
                        ele.discount_rate = Math.floor(Number(ele.discount_rate) - Math.floor((_this.selectedSupplier.discount_percentage * ele.discount_rate) / 100));
                        ele.gst_rate = Math.floor(Number(ele.gst_rate) + Math.floor((_this.selectedSupplier.gst_percentage * ele.gst_rate) / 100));
                    });
    ...
    AddEditSupplierRateComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"],
